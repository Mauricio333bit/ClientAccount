...
// la url es la del server de mongo atlas, si fuera local seria "mongodb://localhost/nuevaBD y poner a correr la base antes, ademas tener mongo instalado en el local"
